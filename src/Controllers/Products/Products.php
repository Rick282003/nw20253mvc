...
class Products extends PublicController
{
    ...
    //Se encarga de obtener los parámetros de la URL
    ...
    //Se encarga de obtener los parámetros de la sesión
    ...
    //Se encarga de guardar los parámetros en la sesión
    ...
    //Se encarga de guardar los parámetros en la variable $viewData para que la vista los pueda mostrar
